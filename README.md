This work main attempts to develop a robust segmentation model using a current segmentation methodology, precisely the deep-learning-based method for detecting glaucoma.
